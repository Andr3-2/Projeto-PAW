...
const routes: Routes = [
  ...
  { path: 'notifications', component: NotificationsListingComponent, canActivate: [AuthGuard,RoleGuard]},
  { path: 'notification-details/:id', component: NotificationDetailsComponent, canActivate: [AuthGuard,RoleGuard]},
